...
//  
// $Header: /home/jonathan/xavier/X_CVS/radtrans/Winds/Grid/Transfer/Lua.cc,v 1.1 2010-07-30 16:45:52 xavier Exp $
// 
...
{
//   _lua_state = lua_open();
   _lua_state = luaL_newstate();  // For recent versions of Lua
