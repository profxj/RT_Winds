...
%profile at very large impact parameter ($\rho > 50$\,kpc), 
...
regularly observes \ion{H}{1} gas with $\tau_0 > 10^7$ \citep{otherguy,pcd+08}.
...
locate the high opacity \ion{H}{1} gas within the outflow.  This is
