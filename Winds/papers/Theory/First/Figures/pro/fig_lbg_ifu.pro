pro fig_lbg_ifu, wrest, dv, grid_file, psfile, YMNX=ymnx, XRNG=xrng, YRNG=yrng
  ...
  if not keyword_set(PSFILE) then psfile = 'fig_lbg_ifu.ps'

  ;; 'Inputs'
;  all_wrest = [2796.35, 2796.35, 2600.173, 2612.654]
  all_wrest = [2796.35, 2796.35]
  dv = [-100., 100., 0, 0]
  ncut = n_elements(all_wrest)
