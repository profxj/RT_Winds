...
\title{Diagnosing Simple Wind Models of Cool Gas Outflows as Viewed by
...
transfer techniques that track the propogation of scattered and
flourescent photons to generate 1D spectra and 2D spectral images.
[Should we make the codes publically available?  Upon request?]
[Mention fiducial model here?]
As expected, the \ion{Mg}{2} doublet exhibits strong, blue-shifted
absorption but one also predicts strong line-emission at roughly
the systemic velocity.  This line-emission `fills-in' the absorption, 
significantly reducing the effective
opacity near systemic. Analysis of cool gas outflows that entirely ignores this
...
(e.g.\ an ISM or slowly infalling component). 
The \ion{Fe}{2} resonance lines show similar behaviour, however 
these lines are connected to optically thin transitions to
fine-structure levels. As such, the \ion{Fe}{2} 
absorption lines more faithfully reproduce the intrinsic opacity
...
galaies at $z<1$.
We also study a scenario purported to describe the outflows
of $z \sim 3$ Lyman break galaxies and argue this model fails to
reproduce the observations when (previously ignored) scattered photons
...
The surface brightness profiles of emission from metal-line
transitions offers a unique means of assessing the morphology and size
of galactic-scale winds motivating deep,
...
\item The line-emission occurs preferentially at the systemic velocity
  ...
  \ion{Na}{1}). The observed absorption profiles may be significantly
...
\centering
\includegraphics[width=3.5in]{../Figures/energy_levels.ps}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=3.5in]{../Figures/oneline_test.eps}
%\epsscale{0.8}
...
\begin{figure}
%\epsscale{0.8}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_nvtau_vs_r.ps}
\caption{
...
\begin{figure}
%\epsscale{0.8}
\includegraphics[width=3.5in]{../Figures/fig_noemiss.ps}
\caption{
...
\begin{figure}
%\epsscale{0.8}
\includegraphics[width=3.5in]{../Figures/fig_fiducial_ifu_mgii.ps}
\caption{
...
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_feii_ifu.ps}
\caption{
...
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_asymm_spec.ps}
\caption{
...
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_dust_spec.ps}
\caption{
Profiles of the \ion{Fe}{2} and \ion{Mg}{2} profiles for the fiducial
...
\begin{figure}
\epsscale{0.8}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_taud_vs_we.ps}
\caption{
...
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_ism_spec.ps}
\caption{
...
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_norm_spec.ps}
\caption{
...
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_lbg_sobolev.ps}
\caption{
...
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_lbg_spec.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_lbg_cumul.ps}
\caption{
...
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_rad_spec.ps}
\caption{
...
%%%% POWER LAWS %%%%
\begin{figure}
\includegraphics[width=3.5in]{../Figures/fig_vary_profiles.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_plaw_spec.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_obs_slit.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_obs_ew.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_obs_peaktau.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_obs_vtau.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_obs_lris.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_obs_sb.ps}
\caption{
...
\begin{figure}
\includegraphics[height=3.5in,angle=90]{../Figures/fig_obs_edelv.ps}
\caption{
...
\input{../Tables/tab_meas_models_nor.tex}
\input{../Tables/tab_plaw_parm.tex}
\input{../Tables/tab_meas_plaws_nor.tex}
