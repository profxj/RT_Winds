...
wind has signficantly lower line emission
...
Similarly, an anisotropicly emitting source would modify the predicted
...
lines, meanwhile, may be modififed by absorption, e.g.\ a wind with
...
systemic.  This is illustrated in Figure~\ref{fig:edelv} which plots
...
Therefore, a slit that exceeds $\approx 0.5 \mrtt$ will admit nearlly
all of the photons scattered to our sightilne.
}
\label{fig:obs_slit}
\end{figure}
...
the majority of scattered photons have this realtive velocity.
...
(solid) and \feiic\ (dotted) transitions.  Both profiles peak at small
...
factor of XXX from $r = 1$\,kpc to $r=10$\,kpc.  Therefore, a
