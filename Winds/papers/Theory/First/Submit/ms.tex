...
\title{Simple Wind Models of Cool Gas Outflows as Viewed by
...
\item Significant line-emission is a generic prediction of simple wind
  ...
  maps (Figure~\ref{fig:fiducial_ifu_mgii}) and surface brightness profiles (Figure~\ref{fig:obs_sb}) of
...
The density falls off initially as $(r/{\rm kpc}-1)^{-0.6}$ initially and then
...
energy and momemtum in the outer regions of the outflow may be very
...
Each of these were normalised to have peak optical depths of 10 to
