...
\ion{C}{2}, and \ion{O}{1} transitions \citep{sgp+96,lkg+97}.
...
the cool gas often exhibits significant \ion{Mg}{2} emission in
...
extended \ion{Mg}{2} emission which they interpret as 
...
and fine-strcuture \ion{Si}{2}$^*$ transitions \citep{prs+02,shapley03}.
...
is very similar to that for \ion{H}{1}
...
(b) Surface-brightness emission maps around the \ion{Fe}{2}~$\lambda
