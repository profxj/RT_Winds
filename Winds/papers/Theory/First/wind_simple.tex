...
Focusing on the \ion{Mg}{2} absorption, one notes the profiles lie
...
is covered by the anisotropic wind.  The resulting \ion{Mg}{2} and
...
\ion{Fe}{2}$^* \; \lambda 2612$ line shows clearly the
...
transitions (e.g.\ \ion {Mg}{2}) in LBGs, only for $z \le 1$ star-forming galaxies
